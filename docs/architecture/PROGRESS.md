...
- 第79便の形状変形command 7 API、処理入力束14 API、色源option data 15 APIについて、読取り専用監査で確定した
  最小契約、専用OBJECT、限定閉包、停止条件を担当票へ記録する。計画commitまでは作業ツリーと局所構築木を
  作成しない。
