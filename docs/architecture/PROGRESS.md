...
- 次の作業: `KisGlobalResourcesInterfaceContractTest.cpp`について、全体資源インターフェースの取得結果と、スレッド・内部ソース生成回数・singleton所有形状を固定する検証を、実際の資源選択、文書読込、画面更新の利用結果と互換性根拠に照らして整理する。
