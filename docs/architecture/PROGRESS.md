...
- 第82並列便はread-only監査済みの`libs/image/kis_random_sub_accessor.h` 7 APIと
  `plugins/paintops/libpaintop/KisCompositeOpOptionData.h` 7 APIに、flake担当の小閉包候補を加えて担当票を確定する。
