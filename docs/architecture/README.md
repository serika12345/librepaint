...
取り消し履歴という5つの内部オブジェクト所有単位を集約する。`kritaimpex`もエラー表現と文書
メタデータを内部オブジェクト所有単位として集約する。公開ライブラリー名とシンボル所有は維持し、
...
公開面から除いた29,013 APIのうち361 APIを対応済みとし、現在の未対応28,652 APIを責務と
