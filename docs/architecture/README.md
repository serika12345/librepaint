...
直接採取し、`docs/architecture/public-api-test-contracts.json`の対応と照合します。
...
対応として固定しました。R2-G19bは廃止した未定義宣言を公開面から除いた29,245 APIのうち
130 APIを対応済みとし、現在の未対応29,115 APIを責務と所有CMake対象ごとにゼロへ縮小します。
