...
#include <kritapaintingmetadata_export.h>
...
class KRITAPAINTINGMETADATA_EXPORT SchemaRegistry
{
    struct Private;
public:
    /**
...
KRITAPAINTINGMETADATA_EXPORT QDebug operator<<(QDebug debug, const KisMetaData::Schema &c);
