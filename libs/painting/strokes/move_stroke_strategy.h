...
class KRITAPAINTING_EXPORT MoveStrokeStrategy : public QObject, public KisStrokeStrategyUndoCommandBased
{
    Q_OBJECT
public:
    ...
    class KRITAPAINTING_EXPORT PickLayerData : public KisStrokeJobData {
    public:
    ...
    struct KRITAPAINTING_EXPORT BarrierUpdateData : public KisAsynchronousStrokeUpdateHelper::UpdateData
    {
