...
namespace KisCommandUtils
{
     ...
     */
    struct KRITAPAINTINGUNDO_EXPORT AggregateCommand : public KUndo2Command {
     ...
     */
    struct KRITAPAINTINGUNDO_EXPORT LambdaCommand : public AggregateCommand {
    ...
    struct KRITAPAINTINGUNDO_EXPORT SkipFirstRedoWrapper : public KUndo2Command {
    ...
    struct KRITAPAINTINGUNDO_EXPORT SkipFirstRedoBase : public KUndo2Command {
    ...
    struct KRITAPAINTINGUNDO_EXPORT FlipFlopCommand : public KUndo2Command {
        enum State {
    ...
    struct KRITAPAINTINGUNDO_EXPORT CompositeCommand : public KUndo2Command {
