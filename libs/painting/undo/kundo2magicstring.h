 ...
 */
class KRITAPAINTINGUNDO_EXPORT KUndo2MagicString : public boost::equality_comparable<KUndo2MagicString>
{
public:
    /**
...
private:
    ...
    template <typename A1, typename A2, typename A3, typename A4>
    friend KUndo2MagicString kundo2_i18nc(const char *ctxt, const char *text, const A1 &a1, const A2 &a2, const A3 &a3, const A4 &a4);
    ...
    template <typename A1, typename A2, typename A3, typename A4>
    friend KUndo2MagicString kundo2_i18np(const char *sing, const char *plur, const A1 &a1, const A2 &a2, const A3 &a3, const A4 &a4);
    ...
    template <typename A1, typename A2, typename A3, typename A4>
    friend KUndo2MagicString kundo2_i18ncp(const char *ctxt, const char *sing, const char *plur, const A1 &a1, const A2 &a2, const A3 &a3, const A4 &a4);
...
{
    return KUndo2MagicString(i18ncp(prependContext(ctxt).toLatin1().data(), sing, plur, a1, a2));
}
...
{
    return KUndo2MagicString(i18ncp(prependContext(ctxt).toLatin1().data(), sing, plur, a1, a2, a3));
}
...
{
    return KUndo2MagicString(i18ncp(prependContext(ctxt).toLatin1().data(), sing, plur, a1, a2, a3, a4));
}
