 ...
 *          Nothing else.
 */
class KRITAPAINTINGUNDO_EXPORT KUndo2Command
{
...
class KRITAPAINTINGUNDO_EXPORT KUndo2QStack : public QObject
{
    Q_OBJECT
...
class KRITAPAINTINGUNDO_EXPORT KUndo2Stack : public KUndo2QStack
{
public:
