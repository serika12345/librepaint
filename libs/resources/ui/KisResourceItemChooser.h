 ...
 */
class KRITARESOURCEUI_EXPORT KisResourceItemChooser : public QWidget
{
    Q_OBJECT
public:
    ...
    /**
     * @param descriptor Resource catalog identity and presentation policy.
     */
    explicit KisResourceItemChooser(KisResourceUiDescriptor descriptor, QWidget *parent = nullptr);
    ~KisResourceItemChooser() override;

    const KisResourceUiDescriptor &descriptor() const;
