...
class KRITATOOLSUI_EXPORT __CategorizedListModelBase : public QAbstractListModel
{
    Q_OBJECT
...
class KRITATOOLSUI_EXPORT KisSortedCategorizedListModel : public QSortFilterProxyModel
{
