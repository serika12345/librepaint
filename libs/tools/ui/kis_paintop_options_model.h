...
struct KRITATOOLSUI_EXPORT KisOptionInfo
{
...
struct KRITATOOLSUI_EXPORT OptionInfoToQStringConverter {
 ...
 */
class KRITATOOLSUI_EXPORT KisPaintOpOptionListModel : public BaseOptionCategorizedListModel
{
public:
