...
void KisAngleGaugeContractTest::defaultStateEnumsAndParentLifetime()
{
...
void KisAngleGaugeContractTest::settersPreserveFiniteConfiguration()
{
    KisAngleGauge gauge;
...
void KisAngleGaugeContractTest::setAngleEmitsOnlyForMeaningfulChanges()
{
    KisAngleGauge gauge;
...
void KisAngleGaugeContractTest::resetUsesConfiguredAngle()
{
    KisAngleGauge gauge;
