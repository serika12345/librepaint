...
LangString RemovingShellEx ${CURRENT_LANG} "正在移除 LibrePaint 系統介面整合元件..."
LangString RemoveShellExFailed ${CURRENT_LANG} "無法成功移除 LibrePaint 系統介面整合元件。"
LangString RemoveShellExDone ${CURRENT_LANG} "已移除 LibrePaint 系統介面整合元件。"
...
LangString SectionShellExDesc ${CURRENT_LANG} "安裝整合元件 (Shell Extension) 以在 Window 檔案總管中顯示 LibrePaint 檔案的縮圖和屬性資訊。$\r$\n$\r$\n版本: ${KRITASHELLEX_VERSION}"
...
LangString ShellExLicensePageHeader ${CURRENT_LANG} "授權協議 (LibrePaint 系統介面整合元件)"
...
LangString DesktopIconPageDesc2 ${CURRENT_LANG} "你可以選擇要否在桌面上建立開啟 LibrePaint 的捷徑:"
...
LangString Msg64bitOn32bit ${CURRENT_LANG} "此電腦正在執行32位元版本的 Windows，但本安裝程式提供的64位元版本 LibrePaint 只能在64位元版本的 Windows 上使用。請取得32位元版本的 LibrePaint。"
LangString Msg32bitOn64bit ${CURRENT_LANG} "你正嘗試在64位元版本的 Windows 上安裝32位元版本的 LibrePaint。本安裝程式建議你安裝效能更高的64位元版本 LibrePaint。$\n$\n你仍要安裝32位元版本的 LibrePaint嗎？"
...
#
LangString MsgKritaSameVerReinstall ${CURRENT_LANG} "發現電腦上已安裝有 ${KRITA_PRODUCTNAME} ${KRITA_VERSION_DISPLAY}。$\n本安裝程式會重新安裝此版本的 LibrePaint。"
LangString MsgKrita3264bitSwap ${CURRENT_LANG} "發現電腦上已安裝有$KritaNsisBitness位元版本的 Krita ($KritaNsisVersion)。本安裝程式會以${KRITA_INSTALLER_BITNESS}位元版本的 LibrePaint ${KRITA_VERSION_DISPLAY} 將其取代。"
LangString MsgKritaNewerAlreadyInstalled ${CURRENT_LANG} "發現電腦上已安裝有$KritaNsisBitness位元版本的 Krita ($KritaNsisVersion)。如需安裝 LibrePaint (${KRITA_VERSION_DISPLAY})，請先自行解除安裝現有版本的 Krita。"
LangString MsgKritaRunning ${CURRENT_LANG} "發現 LibrePaint 正在執行中。使用本安裝程式前請先退出 LibrePaint。"
LangString MsgUninstallKritaRunning ${CURRENT_LANG} "發現 LibrePaint 正在執行中。解除安裝前請先退出 LibrePaint。"
